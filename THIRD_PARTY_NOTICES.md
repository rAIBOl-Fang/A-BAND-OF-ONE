...
## A Band of One derivation notice

A Band of One is a derived project for EasyInput V2.0 / ESP32-S3. Its firmware keeps selected, validated platform-layer boundaries from the EasyInput Maker course motherboard, including the GPIO8 shared power domain, key and encoder input, LED, I2S/audio, partition and BOOT/USB handling. The product-specific score engine, performance state machine and USB-Serial/JTAG control path are maintained by A Band of One; the final product does not ship the course product's HID, BLE HID or EasyInput App chain.

The hardware and platform source is [CY-CHENYUE/easy-input-maker](https://github.com/CY-CHENYUE/easy-input-maker). The formal A Band of One audio asset provenance, licenses, processing metadata and SHA-256 records are in [`firmware/course-motherboard/abo_assets/delivery/ATTRIBUTION.md`](firmware/course-motherboard/abo_assets/delivery/ATTRIBUTION.md) and [`manifest.json`](firmware/course-motherboard/abo_assets/delivery/manifest.json).
