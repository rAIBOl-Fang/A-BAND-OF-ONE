...
class BleInputScheduler {
 public:
  ...
  // Absolute monotonic deadline for the next queued-delivery attempt. Zero
  // means that the first attempt is runnable immediately.
  std::uint64_t next_attempt_us() const;
