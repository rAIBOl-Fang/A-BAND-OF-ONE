...
class SpeakerAssetsRuntimeCore {
 ...
 public:
  ...
  // Publishes the nearest owner-task deadline for partial assembly or an idle
  // logical session. The event-driven platform must not rely on an unrelated
  // periodic wake to expire either protocol lifetime.
